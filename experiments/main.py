...
parser.add_argument('--retrieval_corpus_name', type=str, required=True, help="`corpus_name` for ElasticSearch Retriever")
...
def main(args):
    ...
    QUERY="What does NLP in Artificial Intelligence stand for?"
    response = rag.run(query=QUERY, debug=args.debug)
    print(response)
